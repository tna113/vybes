...
export default function PlaylistItemScreen() {
  ...
  const tracks: Track[] = [
    ...
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "jordan l.", "comment": "underrated gem"}, {"user": "maya p.", "comment": "the lyrics are so deep"}, {"user": "chris r.", "comment": "perfect road trip song"}, {"user": "taylor s.", "comment": "can\'t stop listening"}]',
      ),
      rating: 5,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "david w.", "comment": "this is my jam"}, {"user": "emma h.", "comment": "love the production"}]',
      ),
      rating: 4,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "sarah m.", "comment": "so nostalgic"}, {"user": "mike t.", "comment": "the bridge is amazing"}, {"user": "lisa c.", "comment": "perfect for rainy days"}, {"user": "jake b.", "comment": "this aged like fine wine"}]',
      ),
      rating: 5,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "anna k.", "comment": "this song gets me every time"}]',
      ),
      rating: 0,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "ryan p.", "comment": "the guitar solo is fire"}, {"user": "zoe l.", "comment": "love the energy"}, {"user": "kevin m.", "comment": "this is going on my playlist"}]',
      ),
      rating: 5,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "nina s.", "comment": "the vocals are incredible"}, {"user": "tom w.", "comment": "this song has been stuck in my head"}, {"user": "rachel g.", "comment": "perfect for working out"}, {"user": "dan h.", "comment": "the lyrics speak to me"}]',
      ),
      rating: 4,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "sophie r.", "comment": "this is my comfort song"}]',
      ),
      rating: 0,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "marcus j.", "comment": "the beat is infectious"}, {"user": "claire b.", "comment": "love the melody"}]',
      ),
      rating: 5,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "olivia t.", "comment": "this song is pure magic"}, {"user": "brandon k.", "comment": "the production is top tier"}, {"user": "grace l.", "comment": "can\'t believe I just discovered this"}, {"user": "aaron p.", "comment": "this deserves more recognition"}]',
      ),
      rating: 4,
    },
    {
      ...
      created_at: '2024-01-01T00:00:00Z',
      comments: JSON.parse(
        '[{"user": "isabella m.", "comment": "this song hits different at night"}, {"user": "lucas c.", "comment": "the lyrics are so relatable"}]',
      ),
      rating: 0,
    },
  ];
